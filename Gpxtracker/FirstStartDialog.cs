//------------------------------------------------------------------------------
// <copyright file="FirstStartDialog.cs" company="">
...
namespace GpxTracker
{
	...
	/// <summary>
	/// The first start wizard dialog.
	/// </summary>
	public partial class FirstStartDialog : Form
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="FirstStartDialog"/> class.
		/// </summary>
